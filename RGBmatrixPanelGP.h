...
#ifndef RGBMATRIXPANELGP_H
#define RGBMATRIXPANELGP_H
...
class RGBMATRIXPANELGP : public Adafruit_GFX {

public:
  RGBMATRIXPANELGP(uint8_t a, uint8_t b, uint8_t c, uint8_t clk, uint8_t lat,
                 uint8_t oe, boolean dbuf, uint8_t *pinlist = NULL);

  RGBMATRIXPANELGP(uint8_t a, uint8_t b, uint8_t c, uint8_t d, uint8_t clk,
                 uint8_t lat, uint8_t oe, boolean dbuf, uint8_t width = 32, uint8_t *pinlist = NULL);

  RGBMATRIXPANELGP(uint8_t a, uint8_t b, uint8_t c, uint8_t d, uint8_t e, uint8_t clk,
                 uint8_t lat, uint8_t oe, boolean dbuf, uint8_t width = 32, uint8_t *pinlist = NULL);
