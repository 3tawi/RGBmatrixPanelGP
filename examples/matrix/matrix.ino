...
RGBmatrixPanelGP matrix(A, B, C, D, E, CLK, LAT, OE, true, 64);
// RGBmatrixPanelGP matrix(A, B, C, D, E, CLK, LAT, OE, true, 128);
// RGBmatrixPanelGP matrix(A, B, C, D, CLK, LAT, OE, true, 64);
// RGBmatrixPanelGP matrix(A, B, C, D, CLK, LAT, OE, true, 128, listrgbpins);
